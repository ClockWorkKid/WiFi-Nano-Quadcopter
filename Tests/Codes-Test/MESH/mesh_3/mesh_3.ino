...
*/
const char exampleMeshName[] PROGMEM = "mesh";
const char exampleWiFiPassword[] PROGMEM = "987456321";
...
ESP8266WiFiMesh meshNode = ESP8266WiFiMesh(manageRequest, manageResponse, networkFilter, FPSTR(exampleWiFiPassword), FPSTR(exampleMeshName), "_node_3", true);
