...
class AHRS{
  public:
    ...
    void Initialize();
    void calibraiton(int calMethod);
    float getAccelX();
    float getAccelY();
    float getAccelZ();
    float getGyroX();
    ...
    int16_t readTemp();
    void setTrimRoll(int16_t trimRoll_);
    void setTrimPitch(int16_t trimPitch);
    ...
    void accelCorrection(uint16_t itinary);
    void magCorrection(uint16_t itinary);
    int32_t SUM_GYRO[3] = {0}, SUM_ACCE[3] = {0};
    int16_t MEAN_GYRO[3] = {0}, MEAN_ACCE[3] = {0};
    ...
    int16_t accel[3] = {0}, gyro_int[3] = {0} , mag[3] = {0}, mag_int[3] = {0};
     int16_t accelCal[3] = {0}, gyro_intCal[3] = {0}; 
    ...
    int16_t trimRoll = 0,  trimPitch = 0;
