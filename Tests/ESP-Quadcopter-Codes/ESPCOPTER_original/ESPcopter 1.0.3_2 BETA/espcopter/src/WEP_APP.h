...
//const char *ssid = "ESPcopter 2";         //Name of the access point
//const char *password = "12345678";    //Password for the access point


#if defined(WEB_APP_WIFI_SSID) == 0
#define WEB_APP_WIFI_SSID "ESPcopter" 
#endif

#if defined(WEB_APP_WIFI_PASSWORD) == 0
#define WEB_APP_WIFI_PASSWORD "12345678" 
#endif
...
void setupWiFi(){    
  ...
  WiFi.softAP(WEB_APP_WIFI_SSID,WEB_APP_WIFI_PASSWORD);
