#ifndef _ROS_stdr_msgs_ThermalSensorMsg_h
#define _ROS_stdr_msgs_ThermalSensorMsg_h
...
namespace stdr_msgs
{
  ...
  class ThermalSensorMsg : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "stdr_msgs/ThermalSensorMsg"; };
    const char * getMD5(){ return "fea53ce0501404c91ee4c18275946ca8"; };
