#ifndef _ROS_stdr_msgs_SoundSensorMsg_h
#define _ROS_stdr_msgs_SoundSensorMsg_h
...
namespace stdr_msgs
{
  ...
  class SoundSensorMsg : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "stdr_msgs/SoundSensorMsg"; };
