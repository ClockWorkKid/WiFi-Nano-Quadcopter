...
/*
    Serial.print( attitudeRadian[0] );
    Serial.print(" , ");
    Serial.print( attitudeRadian[1] );
    Serial.println();
*/
  ...
  if( stopFlightHand > 50){
   ...
   yaw.compute( 2 , SetPoint[2] , throttle,Trim_Yaw, (degree[0]+ yaw_Control)*100, -rate[2]);
   }else{
   ahrs.setZero();  
   }
  }
